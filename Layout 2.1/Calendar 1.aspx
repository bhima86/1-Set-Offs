...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Box1">
          ...
          <asp:Calendar ID="Calendar1" runat="server" Height="466px" Width="620px" OnSelectionChanged="Calendar1_SelectionChanged" CellSpacing="2" Font-Bold="True" Font-Size="Large" SelectedDate="05/05/2023 12:14:16" OnDayRender="Calendar1_DayRender">
  ...
  <div class="Box2">
      <asp:GridView ID="GridView1" runat="server" 
        ...
        <asp:Button ID="Button2" runat="server" Text="Upcoming Holidays" OnClick="Button2_Click" />
    </form>
</body>
</html>
